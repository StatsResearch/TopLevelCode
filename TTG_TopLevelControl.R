...
# SVN: $Id: TTG_TopLevelControl.R 619 2012-05-06 21:10:06Z rob $
...
log.filename<-paste(sep='',INSTALL_DIR,'/PhDStuff/ThesisSoftware/Logs/TTG-TLC-output-',smallname,'-EH-',event.horizon,'.log')
log.level<-3
...
TTG.output.dir<-paste(sep='',INSTALL_DIR,'/PhDStuff/ThesisSoftware/TrgTestGenerator/output_',event.horizon)
...
all.window.sizes<-c(5,10,15,20,25,30)
